...
void PrintSymTable() 
{
	...
	while(tempGhead) {
		printf("\tName : %s ; Type : %d ; FuncReturn Type : %d ; Size : %d ; Arg count : %d ; Binding : %d\n" ,
...
LSymbolTable* Linsert(char* sym_name, int sym_type, int arg_var)
{
	if(Lhead == NULL)
	{
